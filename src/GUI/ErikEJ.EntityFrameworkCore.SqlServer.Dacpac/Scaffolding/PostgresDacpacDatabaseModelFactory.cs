...
{
    public class PostgresDacpacDatabaseModelFactory : IDatabaseModelFactory
    {
        ...
        public PostgresDacpacDatabaseModelFactory()
        {
        }

        public PostgresDacpacDatabaseModelFactory(PostgresDacpacDatabaseModelFactoryOptions options)
        {
