...
{
    public class PostgresFunctionModelFactory : PostgresRoutineModelFactory, IFunctionModelFactory
    {
        public PostgresFunctionModelFactory()
        {
            RoutineType = "FUNCTION";

            //TODO: Needs to be rewritten for Postgres.  This is still an SQL Server SELECT statement.  
            RoutineSql = $@"
SELECT
    ROUTINE_SCHEMA,
    ROUTINE_NAME,
